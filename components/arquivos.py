...
arquivos_vendas = pd.concat((pd.read_excel(cont, usecols=['Creation Date', 'Order', 'ID_SKU', 'SKU Name', '_CodigoReferenciaProduto', 'Quantity_SKU', 'Reference Code', 'SKU Selling Price']) for cont in pasta_vendas), ignore_index=True)
